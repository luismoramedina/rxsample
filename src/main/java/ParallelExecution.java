...
public class ParallelExecution {
    ...
    private static void zipAsync() {
        BlockingObservable<Object> objectBlockingObservable = Observable.zip(getDataAsync(1), getDataAsync(2),
                (Func2<Integer, Integer, Object>) (integer, integer2) -> integer + integer2).toBlocking();
        objectBlockingObservable.subscribe(integer -> System.out.print("Zip result: " + integer));
    }
